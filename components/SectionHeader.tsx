...
const SectionHeader = ({
  ...
  return (
    <div className="flex flex-col items-start space-y-4 p-4 sm:px-8 md:px-[150px] lg:px-0 ">
      ...
      <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row  md:gap-x-8 md:gap-y-4">
