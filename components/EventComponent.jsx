    ...
    <>
      <section className="flex flex-col justify-center align-center ">
        <div className="bg-red-100 ">
          <div className="w-full max-w-[80%] md:max-w-[50%] lg:max-w-[50%] mx-auto ">
        ...
        <div className="w-full max-w-[80%] md:max-w-[50%] lg:max-w-[50%]  mx-auto items-center">
          <div className="w-full flex flex-col  justify-center my-4">
            <h2 className="text-xl text-start font-bold my-4 lg:text-4xl">
              About
            </h2>
            <p className="text-start text-sm my-4 md:text-lg text-balance  lg:pr-12  lg:text-xl">
            ...
            <p className="text-sm my-4 md:text-lg lg:pr-12 lg:text-xl text-balance">
          ...
          <div className="my-4 flex flex-col justify-center items-start ">
            <h2 className="text-2xl font-bold text-start">Other Events</h2>
            <div className="">
